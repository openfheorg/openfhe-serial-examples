...
public:
  ...
  void RequestAddCT(void) {
    olc::net::message<ThreshMsgTypes> msg;
    msg.header.id = ThreshMsgTypes::RequestAddCT;
    Send(msg);
  }

  void RequestMultCT(void) {
    olc::net::message<ThreshMsgTypes> msg;
    msg.header.id = ThreshMsgTypes::RequestMultCT;
    Send(msg);
  }

  void RequestSumCT(void) {
    olc::net::message<ThreshMsgTypes> msg;
    msg.header.id = ThreshMsgTypes::RequestSumCT;
    Send(msg);
  }
...
// case. will be removed once all testing is done.
